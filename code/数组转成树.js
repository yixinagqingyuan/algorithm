...
if (
  !(
    rootNode1 &&
    rootNode1.children.find((c) => c.id === 2) &&
    rootNode1.children.find((c) => c.id === 2).children.length === 1
  )
) {
...
if (
  !(
    rootNode1 &&
    rootNode1.children.find((c) => c.id === 3) &&
    rootNode1.children.find((c) => c.id === 3).children.length === 1
  )
) {
...
if (
  !(
    rootNode2 &&
    rootNode2.children.length === 1 &&
    rootNode2.children.find((c) => c.id === 6)
  )
) {
